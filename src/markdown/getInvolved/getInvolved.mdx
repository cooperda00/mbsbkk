...
<OutButton path="google.com" text="Apply Now" />

Please note that MBSBKK is a carefully curated event and places are limited. Please complete all applications fully and in a way that reflects your passion for what you are offering.
...
<OutButton path="mailto:info@mbsbkk.com" text="Sponsor Us" />
...
For other enquiries please email <span><a href="mailto:info@mbsbkk.com">info@mbsbkk.com</a></span>
